...
%py% -m pip install %~dp0\Dep\32\scikit_learn-0.15.1-cp27-none-win32.whl
...
%~dp0\Dep\32\nltk-3.2.win32.exe
%~dp0\Dep\32\scipy-0.12.0-win32-superpack-python2.7.exe
%~dp0\Dep\32\JPype-0.5.4.2.win32-py2.7.exe
